      ...
      <div className="bg-zinc-950 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
          <div className="mx-auto max-w-2xl">
            <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Top Finds</h2>
            <p className="mt-4 text-lg leading-8 text-gray-400">
            Discover Our Top 10 Finds Where Excellence Meets Discovery!
            </p>
          </div>
          <ul
            role="list"
          ...
          >
            {people.map((person) => (
              <li key={person.name} className="rounded-2xl bg-zinc-500 px-8 py-10">
